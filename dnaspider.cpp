...
wstring editor = L"Notepad", editor1 = L"Visual Studio Code", db = L"db.txt - ", se = L"se.txt - ", editorSe = se + editor1, editorDb = db + editor1;
...
void replace_q(wstring &a, wstring b, wstring c) {//cc @ qp = regex_replace(qp, wregex(L"\\\\g"), L">"). a=qp, b=">", c="g" 
